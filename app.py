...
# --- BRIDGE DE SEGURIDAD (Añadido para Streamlit Cloud) ---
load_dotenv()
if "SHODAN_API_KEY" in st.secrets:
    os.environ["SHODAN_API_KEY"] = st.secrets["SHODAN_API_KEY"]
# Repite para otras keys si es necesario
...
<style>
    ...
    * { font-family: 'Inter', sans-serif; }
    ...
    /* SUBTÍTULO Y TEXTOS: Forzamos color dinámico */
    .main-subtitle, p, span, label, .stMarkdown {
...
<div style='text-align: center; padding: 20px; margin-top: 40px;'>
    ...
    <p style='font-size: 0.85em; color: gray;'>Enterprise Threat Intelligence • Real-time Monitoring • Advanced Analytics</p>
</div>
""", unsafe_allow_html=True)
